...
public class TelaConsultaActivity extends AppCompatActivity
    ...
    private static final String TAG = TelaConsultaActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPager = (ViewPager) findViewById(R.id.tela_consulta_view_pager);
        mPager.setAdapter(new MyPageAdapter(getSupportFragmentManager()));

        mTabs = (SlidingTabLayout) findViewById(R.id.tela_consulta_tab_layout);
    ...
    public static class MyFragment extends Fragment {
        ...
        private TextView textView_consultar;
        private String oferta_ou_demanda;
        private EditText editText_nome;
        private EditText editText_qntd;
        ...
        public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            View layout = inflater.inflate(R.layout.fragment_consulta, container, false);
            Bundle bundle = getArguments();
            textView_consultar = (TextView) layout.findViewById(R.id.fragment_consultar_txtview_consultar);
            editText_nome = (EditText) layout.findViewById(R.id.fragment_consultar_editText_nome_produto);
            editText_qntd = (EditText) layout.findViewById(R.id.fragment_consultar_editText_qntd_produto);
            button_consultar = (Button) layout.findViewById(R.id.fragment_consultar_button_consultar);
            linearLayout = (LinearLayout) layout.findViewById(R.id.fragment_consultar_linearlayout_busca);
            oferta_ou_demanda = getResources().getStringArray(R.array.tab_oferta_demanda)[bundle.getInt("position")];
            if (bundle != null) {
                textView_consultar.setText("Consultar " + oferta_ou_demanda + "s");

                button_consultar.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        String nome_busca = editText_nome.getText().toString();
                        String qntd_busca = editText_qntd.getText().toString();
                        if (nome_busca.contentEquals("") || qntd_busca.contentEquals("")) {
                            ...
                            try {
                                ...
                                String[] str_params = {"select" + (oferta_ou_demanda.toLowerCase()) + "s", nome_busca, qntd_busca};
                                BackgroundTask task = new BackgroundTask(v.getContext());
                                ...
                                for (int i = 0; i < jsonarray.size(); i++) {
                                    ...
                                    BackgroundTask task_user = new BackgroundTask(v.getContext());
